      ...
      <div className={styles.container}>
        ...
        <div className={styles.split}>
          <div className={styles.card}>
            ...
            <p className={styles.p}>
              A practical takeaway from the selected evidence is simple: ask whether movement, upright
              positioning, or a non-lithotomy option is possible before assuming there is only one
              way to labor or push.
            </p>
          </div>
          ...
          <div className={styles.card}>
            ...
            <p className={styles.p}>
              ...
              reasonable policy-facing implication of the selected literature, but it should still be
              presented as an argument grounded in supportive-care logic rather than as a standalone
